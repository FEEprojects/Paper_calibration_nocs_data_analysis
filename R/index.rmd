...
The data needs to be downloaded from ZENODO_REPOSITORY LINK and placed in the
`data` folder in .rds format. Then the script `R/utilities/data_preparation.r`
must be ran to tidy and collate the different datasets used in the study, see
[Data preparation](#data_preparation) for more details.
